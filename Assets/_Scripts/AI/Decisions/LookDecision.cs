...
public class LookDecision : AIDecision
{
    ...
    [SerializeField]
    private LayerMask racycastMask = new LayerMask();
    ...
    public override bool MakeADecision()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, direction, Distance, racycastMask);
    ...
    {
        if (UnityEditor.Selection.activeObject == gameObject && enemyBrain != null &&
